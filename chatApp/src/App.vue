...
@font-face {
  ...
  src: url("./assets/fonts/GUBBLO___.eot?") format("eot"), url("./assets/fonts/GUBBLO___.woff") format("woff"),
    url("./assets/fonts/GUBBLO___.ttf") format("truetype"),
    url("./assets/fonts/GUBBLO___.svg#Gubblebum-Blocky") format("svg");
  font-weight: normal;
  font-style: normal;
}
